...
namespace Com.Alipay
{
    ...
    public class Submit
    {
        ...
        private static string BuildRequestMysign(Dictionary<string, string> sPara,string signStr)
        {
            ...
            {
                case "MD5":
                    mysign = AlipayMD5.Sign(prestr,signStr, _input_charset);
                    break;
                default:
                    mysign = "";
                    break;
        ...
        private static Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            string signStr;
            sParaTemp.TryGetValue("sign", out signStr);
            //签名结果
            string mysign = "";
            sParaTemp.Remove("sign");

            //过滤签名参数数组
            sPara = Core.FilterPara(sParaTemp);

            //获得签名结果
            mysign = BuildRequestMysign(sPara,signStr);
